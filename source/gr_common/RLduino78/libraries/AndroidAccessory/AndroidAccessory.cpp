...
AndroidAccessory::AndroidAccessory(const char *manufacturer,
                                   ...
                                   const char *serial)
{
    g_pManufacturer = (char *)manufacturer;
    g_pModel        = (char *)model;
    g_pDescription  = (char *)description;
    g_pVersion      = (char *)version;
    g_pUri          = (char *)uri;
    g_pSerial       = (char *)serial;
}
...
bool AndroidAccessory::switchDevice(byte addr)
{
    ...
    sendString(addr, ACCESSORY_STRING_MANUFACTURER, g_pManufacturer);
    sendString(addr, ACCESSORY_STRING_MODEL, g_pModel);
    sendString(addr, ACCESSORY_STRING_DESCRIPTION, g_pDescription);
    sendString(addr, ACCESSORY_STRING_VERSION, g_pVersion);
    sendString(addr, ACCESSORY_STRING_URI, g_pUri);
    sendString(addr, ACCESSORY_STRING_SERIAL, g_pSerial);
